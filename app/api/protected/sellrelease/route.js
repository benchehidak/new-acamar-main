...
export async function POST(req) {
  ...
  const client = await clientPromise;
    ...
    let price = 20;
    const {name , email, phoneNumber, seller,release} = await req.json();
      ...
      const mailOptions = {
          ...
          <html>
            <head>
              ...
              .letter {
                background-image: url("https://i.imgur.com/bcf2xUP.jpeg");
            ...
            <body class="letter">
            <h1>Your HOTCUE X ACAMAR Event Ticket </h1>
              <h1>Dear ${name},</h1>
              <p>Thank you for purchasing a ticket to attend ACAMAR on July 18, 2024 10PM, Sousse. Attached to this email, you will find your personalized ticket with a unique QR code.</p>
              <h2>Instructions:</h2>
              <ol>
                  <li>Keep a digital or printed copy of this email with your QR code.</li>
